...
namespace OFTENCOFTAPI.ApplicationCore.Models.ViewModels
{
    ...
    //    var HookResponse = HookResponse.FromJson(jsonString)
        ...
        public partial class HookResponse
        {
            public static HookResponse FromJson(string json) => JsonConvert.DeserializeObject<HookResponse>(json, OFTENCOFTAPI.ApplicationCore.Models.ViewModels.Converter.Settings);
        }

        public static class Serialize
        {
            public static string ToJson(this HookResponse self) => JsonConvert.SerializeObject(self, OFTENCOFTAPI.ApplicationCore.Models.ViewModels.Converter.Settings);
        }
